...
- chore: removes sdk terminate when accountsChanged comes in empty ([#1148](https://github.com/MetaMask/metamask-sdk.git/pull/1148))
...
[Unreleased]: https://github.com/MetaMask/metamask-sdk.git/compare/@metamask/sdk@0.31.1...HEAD
