...
## [0.30.0]
### Uncategorized
- feat: wallet_requestpermissions update local provider accounts ([#1081](https://github.com/MetaMask/metamask-sdk.git/pull/1081))
- fix: connectAndSign send as hexString ([#1082](https://github.com/MetaMask/metamask-sdk.git/pull/1082))
- feat: sdk integration improvements ([#1080](https://github.com/MetaMask/metamask-sdk.git/pull/1080))
- feat: fake metamask wallet detection ([#1074](https://github.com/MetaMask/metamask-sdk.git/pull/1074))
...
[Unreleased]: https://github.com/MetaMask/metamask-sdk.git/compare/@metamask/sdk@0.30.0...HEAD
