...
## [0.29.1]
### Uncategorized
- feat: emit connectWithResponse event ([#1067](https://github.com/MetaMask/metamask-sdk.git/pull/1067))
- feat: always re-emit display uri event ([#1066](https://github.com/MetaMask/metamask-sdk.git/pull/1066))
- fix: improper implementation of handleBatchMethod + more robust tests ([#1065](https://github.com/MetaMask/metamask-sdk.git/pull/1065))
...
[Unreleased]: https://github.com/MetaMask/metamask-sdk.git/compare/@metamask/sdk@0.29.1...HEAD
