...
- fix: connectWith potnetially returning incorrect response ([#1053](https://github.com/MetaMask/metamask-sdk.git/pull/1053))
- fix: unit tests ([#1055](https://github.com/MetaMask/metamask-sdk.git/pull/1055))
- feat: default web url metadata ([#1043](https://github.com/MetaMask/metamask-sdk.git/pull/1043))
- feat: missing extension analytics event for personal_sign ([#1048](https://github.com/MetaMask/metamask-sdk.git/pull/1048))
...
[Unreleased]: https://github.com/MetaMask/metamask-sdk.git/compare/@metamask/sdk@0.29.0...HEAD
