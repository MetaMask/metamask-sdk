...
export type MockedData = {
	initSpy: t.MockInstance<MultichainConnect['init']>;
	setupAnalyticsSpy: t.MockInstance<MultichainConnect['setupAnalytics']>;
	emitSpy: t.MockInstance<MultichainConnect['emit']>;
