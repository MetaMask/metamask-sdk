...
export const DEFAULT_SERVER_URL = "https://metamask-sdk-socket.metafi.codefi.network/";
...
export const SDKConfigProvider = ({
  ...
  const syncState = (newState: CustomContext) => {
    ...
    const newurl = `${window.location.protocol}//${window.location.host}${window.location.pathname}?${queryString.toString()}`;
